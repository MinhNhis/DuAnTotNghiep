                    ...
                    danhgia
                      ...
                      .map((danhgia) => (
                        <Box
                          ...
                          sx={{
                            display: "flex",
                            flexDirection: "row", // Sử dụng bố cục ngang
                        ...
                        >
                          ...
                          <Box
                            sx={{
                              ...
                              paddingLeft: "20px", // Tạo khoảng cách giữa hai cột
                            }}
                          >
                            <Box
                              sx={{
                              ...
                              {nguoidungdanh.map((ngdg) => {
                                if (ngdg.id_nguoidung === danhgia.id_nguoidung) {
                                  return (
                                    ...
                                    >
                                      <strong>Người dùng: {ngdg.ten_nguoi_dung}</strong>
                                    </Typography>
                                  );
                                } else return null;
                              })}
                            ...
                            <Box>
                              ...
                              >
                                <h1 style={{ fontSize: "15px" }}>Đánh giá</h1>
                              ...
                              >
                                <h1 style={{ fontSize: "15px" }}>Các đánh giá khác</h1>
